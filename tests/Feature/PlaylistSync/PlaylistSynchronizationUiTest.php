...
class PlaylistSynchronizationUiTest extends TestCase
{
    ...
    public function test_attention_codes_have_stable_safe_messages_and_keep_the_bank_visible(): void
    {
        ...
        $messages = [
            ...
            'rate-limited' => 'Platforma chwilowo ograniczyła żądania.',
            'quota-limited' => 'Dzienny limit YouTube został wyczerpany.',
            'write-admission-limited' => 'Dzienny limit zapisów aplikacji został osiągnięty.',
