...
@section('content')
    <article class="mx-auto max-w-3xl">
        ...
        <div class="mt-8 space-y-6 text-base leading-7 text-ash-grey-200/80">
            ...
            <p>Dane playlisty zapisujemy w prywatnym banku użytkownika. Okresowo je odświeżamy, a gdy nie można potwierdzić ich aktualności, usuwamy metadane pochodzące z YouTube albo przestajemy przedstawiać je jako aktualne. Użytkownik może usunąć konto i powiązane dane zgodnie z dostępnymi funkcjami usługi.</p>
