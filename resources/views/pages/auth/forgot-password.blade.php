<x-layouts.auth>
    <div class="space-y-6">
        <div>
            ...
            <p class="mt-2 text-sm text-ash-grey-300">Wyślemy instrukcję zmiany hasła, jeśli konto używa tego adresu.</p>
        </div>
        ...
        <p class="text-center text-sm"><a href="{{ route('login') }}" class="auth-link">Wróć do logowania</a></p>
    </div>
</x-layouts.auth>
