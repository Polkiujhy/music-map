...
{
    public static function response(Response $response, ?ManagedExportFailureCode $rejected = null): ManagedProviderFailure
    {
        ...
        if (in_array($reason, ['quotaExceeded', 'dailyLimitExceeded', 'QUOTA_EXCEEDED'], true)) {
            return new ManagedProviderFailure(ManagedExportFailureCode::QuotaExceeded, true);
        }
        ...
        return match ($response->status()) {
            ...
            404 => new ManagedProviderFailure(ManagedExportFailureCode::TargetMissing),
