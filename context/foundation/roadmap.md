...
| ----- | ---------------------- | --------------------------------- | ---------------- | -------------- | -------- |
| F-01 | `platform-access-readiness` | (fundament) lokalnie zweryfikowano minimalny dostęp testowych aplikacji i kont technicznych do Spotify i YouTube oraz zdefiniowano bezpieczny kontrakt konfiguracji produkcyjnej | aktywne testowe projekty deweloperskie, poświadczenia aplikacji i dedykowane konta techniczne Spotify oraz YouTube | FR-004, FR-006, FR-009, FR-010, NFR-003, NFR-006 | planning |
...
- **Wynik:** (fundament) lokalnie zweryfikowano minimalny dostęp testowych aplikacji i dedykowanych kont technicznych do Spotify i YouTube, a dla produkcji zdefiniowano publiczny kontrakt bezpiecznej konfiguracji, odświeżania i unieważniania poświadczeń.
...
- **Wymagania wstępne:** aktywne testowe projekty deweloperskie, poświadczenia aplikacji i dedykowane konta techniczne Spotify oraz YouTube; produkcyjne wartości pozostają poza repozytorium.
- **Równolegle z:** S-01.
