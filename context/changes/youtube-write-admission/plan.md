...
- [x] 1.4 Przegląd potwierdza zgodność NFR-006, F-02 i konfiguracji — c90baac
- [x] 1.5 Przegląd potwierdza niezależność kontraktu od przyszłych konsumentów i PaaS — c90baac
...
- [x] 2.5 Przegląd potwierdza commit dopuszczenia przed przyszłym requestem YouTube — c90baac
- [x] 2.6 Inspekcja schematu potwierdza minimalne dane i brak zwalniania rezerwacji — c90baac
...
- [x] 3.5 Disposable PostgreSQL potwierdza limit, odmowę i retry po restarcie — c90baac
- [x] 3.6 Kandydat addytywnego schematu jest gotowy do publicznej operacji schema-release — c90baac
- [x] 3.7 Przegląd potwierdza brak requestów YouTube i gotowość dla S-06–S-09 — c90baac
